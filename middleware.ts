...
const PUBLIC_ROUTES = ['/', '/login', '/signup', '/signup/brautpaar', '/signup/veranstalter', '/signup/dienstleister', '/bewerbung', '/auth/callback', '/join', '/password-reset', '/datenschutz', '/cookies', '/impressum']

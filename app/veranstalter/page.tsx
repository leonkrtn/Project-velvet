...
function LocationTab() {
  ...
  return (
    <div>
      ...
      {/* Account anlegen stub */}
      <div style={{ marginTop: 32, borderTop: '1px solid var(--border)', paddingTop: 24 }}>
        <p style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em', color: 'var(--text-dim)', marginBottom: 8 }}>Weitere Funktionen</p>
        <button disabled style={{
          display: 'flex', alignItems: 'center', justifyContent: 'space-between',
          width: '100%', padding: '13px 16px', border: '1px solid var(--border)',
          borderRadius: 'var(--r-sm)', background: 'var(--bg)', cursor: 'not-allowed',
          fontFamily: 'inherit', opacity: 0.7,
        }}>
          <span style={{ fontSize: 14, color: 'var(--text)' }}>Account anlegen</span>
          <span style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.08em', color: 'var(--text-dim)', padding: '2px 8px', background: 'var(--surface)', borderRadius: 20, border: '1px solid var(--border)' }}>Bald verfügbar</span>
        </button>
      </div>
    </div>
  )
...
// ── Main Page ──────────────────────────────────────────────────────────────
type Tab = 'dienstleister' | 'hotels' | 'catering' | 'funktionen' | 'deko' | 'location'

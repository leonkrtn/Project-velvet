...
export const VENDOR_TOUR_STEPS: VendorTourStep[] = [
  ...
  { module: 'anfragen', area: 'anfragen', target: 'vdr-offer-tabs',
    title: 'Antworten & Angebot',
    body: 'Unter „Antworten" siehst du, was das Brautpaar im Formular ausgefüllt hat. Unter „Angebot" den automatisch erstellten Entwurf — Positionen, Preise, Gesamtbetrag.',
    interactive: true },

...
export const TEMPLATES: WeddingTemplate[] = [
  {
    ...
    vars: {
      ...
      '--wd-line': '#e3d9c8',
      '--wd-radius': '4px',
      '--wd-hero-overlay': 'linear-gradient(180deg, rgba(20,16,12,0.25), rgba(20,16,12,0.45))',
  ...
  },
  {
    ...
    vars: {
      ...
      '--wd-line': '#e6e6e6',
      '--wd-radius': '0px',
      '--wd-hero-overlay': 'linear-gradient(180deg, rgba(0,0,0,0.15), rgba(0,0,0,0.4))',
  ...
  },
  {
    ...
    vars: {
      ...
      '--wd-line': '#d3dac6',
      '--wd-radius': '14px',
      '--wd-hero-overlay': 'linear-gradient(180deg, rgba(30,40,25,0.2), rgba(30,40,25,0.45))',
  ...
  },
  {
    ...
    vars: {
      ...
      '--wd-line': '#efd9d8',
      '--wd-radius': '24px',
      '--wd-hero-overlay': 'linear-gradient(180deg, rgba(70,40,40,0.18), rgba(70,40,40,0.4))',
  ...
  },
  {
    ...
    vars: {
      ...
      '--wd-line': '#ddd6c9',
      '--wd-radius': '2px',
      '--wd-hero-overlay': 'linear-gradient(120deg, rgba(20,18,15,0.5), rgba(20,18,15,0.15))',
